...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo" >
        <span class="logo-mini" style="height:95%">
            <img src="{{ asset('website-logo_mini.png') }}" height="100%" alt="Logo" >
        </span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg" style="height:95%">
            <img  src="{{ asset('website-logo.png') }}" height="100%" alt="The website Logo" >
        </span>
    </a>
    <!-- Header Navbar ,try to style it in header.less-->
               ...
               {{--  add any other items  --}}
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">Mina Reda Albert ,Make it dynamic</span>
                    </a>
                    <ul class="dropdown-menu">
